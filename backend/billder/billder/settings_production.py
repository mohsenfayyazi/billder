"""
Django settings for billder project - Production version
"""
...
WSGI_APPLICATION = 'billder.wsgi.application'
...
REST_FRAMEWORK = {
    ...
    'EXCEPTION_HANDLER': 'billder.exceptions.custom_exception_handler',
}
